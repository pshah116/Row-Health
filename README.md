...
• [Technical Process and Caveats](#technical-process-and-caveats)
...
• **Signup Count**: Total number of signups achieved throughout 2019-2023 
...
• Used **calculated fields** to compute: Click-through rate (CTR), Cost per person (CPP), Signup rate

• Used **filters to alternate views** based on plan, state, and campaign type

• **Minimal data cleaning was required** for this dataset but could involve: Checking for nulls and nonsensical values, aligned date types, and augmented missing data if needed
